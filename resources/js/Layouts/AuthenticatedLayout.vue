...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 bg-[url('/tile-background-light.webp')] dark:bg-[url('/tile-background-dark.webp')]">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <div>
                                <span
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-md cursor-default

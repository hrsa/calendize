...
<template>
    <Head>
        <title>{{ $t("dashboard.pricing.title") }}</title>
        <meta name="description" :content="$t('dashboard.pricing.meta')" />
    </Head>
    <GuestLayout>
        <div
            class="flex flex-col gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition
                duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-hidden focus-visible:ring-[#FF2D20] lg:gap-8 lg:p-10 lg:pb-10
                dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
        >
            <div>
                <h1 class="mx-auto mb-4 px-8 text-center text-xl">
                    {{ $t("dashboard.pricing.description.main") }}
                </h1>
                <h3 class="mx-auto px-8 text-center text-sm">
                    {{ $t("dashboard.pricing.description.cancellation") }}
                </h3>
                <h3 class="mx-auto px-8 text-center text-sm">
                    {{ $t("dashboard.pricing.description.refunds") }}
                </h3>
            </div>
